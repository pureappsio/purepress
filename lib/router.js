...
Router.map(function() {
    this.route('postserver', {
        ...
        action: function() {
            ...
            // Visitor
            Meteor.call('insertVisitor', this.request.headers, this.params.query);
            ...
            if (Pages.findOne({ url: this.params.post_url, link: { $exists: true } })) {
                ...
                if (Metas.findOne({ type: 'blogPage' })) {
                    ...
                    if (blogPage.url == this.params.post_url) {
                        ...
                        // Render HTML
                        var html = Meteor.call('renderPost', this.params.post_url, location, this.params.query, this.request.headers);
            ...
            if (Metas.findOne({ type: 'homePage' })) {
                ...
                if (Metas.findOne({ type: 'blogPage' })) {
                    ...
                    if (metaBlog.value == meta.value) {
                        ...
                        // Render home page
                        var html = Meteor.call('renderPost', homePage.url, location, this.params.query, this.request.headers);
                    }
